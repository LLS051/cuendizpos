...
class Customer_due_receive_model extends CI_Model {
    ...
    public function getCustomerDue($customer_id) {
        ...
        $customer_due = $this->db->query("SELECT SUM(due_amount) as due FROM tbl_sales WHERE customer_id=$customer_id and outlet_id=$outlet_id and del_status='Live' and payment_method_id=5")->row(); 
