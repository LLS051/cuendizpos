...
class Supplier_payment_model extends CI_Model {
    ...
    public function getSupplierDue($supplier_id) {
        ...
        $supplier_due = $this->db->query("SELECT SUM(grand_total) as due FROM tbl_purchase WHERE supplier_id=$supplier_id and outlet_id=$outlet_id and del_status='Live'")->row();
