...
class Dashboard extends CI_Controller {
    ...
    public function dashboard() { 
        ...
        */
        ...
        $data['supplier_payable'] = $this->Dashboard_model->supplier_payable($first_day_this_month, $last_day_this_month);   
        $data['customer_regalia'] = $this->Dashboard_model->customer_regalia($first_day_this_month, $last_day_this_month); 
