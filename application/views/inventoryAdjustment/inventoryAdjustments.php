...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-3">
            <a href="<?php echo base_url() ?>Inventory_adjustment/addEditInventoryAdjustment"><button style="background: #ffd700; color: black;" type="button" class="btn btn-block  pull-right"><?php echo lang('add_inventory_Adjustment'); ?></button></a>
        </div>
    </div>
</section>
                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 13%"><?php echo "Recuento de productos"; ?></th>
