        ...
        <div class="col-md-2">
            <div class="form-group"> 
                <select class="form-control select2 category_id" name="category_id" id="category_id" style="width: 100%;">
                    <option value="" disabled selected hidden ><?php echo lang('category'); ?></option>
        ...
        <div class="col-md-2"> 
            <div class="form-group"> 
                <select class="form-control select2" name="ingredient_id" id="ingredient_id" style="width: 100%;">
                    <option value="" disabled selected hidden ><?php echo lang('ingredient'); ?></option>
        ...
        <div class="col-md-2">
            <div class="form-group">
                <select class="form-control select2" name="food_id" id="food_id" style="width: 100%;">
                    <option value="" disabled selected hidden ><?php echo lang('food_menu'); ?></option>
