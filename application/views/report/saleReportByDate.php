                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo ('Total Credito/Regalia'); ?></th>
                                <th><?php echo ('Total Venta + Credito/Regalia'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            if (isset($saleReportByDate)):
                                foreach ($saleReportByDate as $key => $value) {
                                    ...
                                    $dueTotalSum+=$value->due_total;
                                    $totalAll+=$value->total_sum_paiddue;
                                    $key++;
                                    ?>
                                    
                              
                                    <tr>
                                        <?php var_dump($value->c_sum_paid)?>
                                        <td style="text-align: center"><?php echo $key; ?></td>
                                        <td><?= date($this->session->userdata('date_format'), strtotime($value->sale_date)) ?></td>
                                        <td><?php echo $value->total_payable ?></td>
                                        <td><?php echo $value->due_total ?></td>
                                        <td><?php echo $value->total_sum_paiddue ?></td>
                                    </tr>
                                    <?php
                                }
                            endif;
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><?= number_format($dueTotalSum, 2) ?></th>
