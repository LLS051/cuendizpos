    ...
    if(isset($register_info) && count($register_info)>0){
        ...
        foreach($register_info as $single_register_info){
         ...
         //echo "<pre>";
            ...
            $stripe = is_null($payment_methods_sale)?lang('register_stripe').'0.00':lang('register_stripe').$payment_methods_sale->Stripe;
           ...
           // $show_register_report .= '<td>'.$single_register_info->sumPayStripe.'</td>';
            $show_register_report .= '<td>'.$single_register_info->sumPay.'</td>';
            $show_register_report .= '<td>'.$single_register_info->sumStripe.'</td>';
            ...
            $show_register_report .= '<td>'.$single_register_info->payment_methods_sale.'</td>';
            
            //$show_register_report .= '<td>'.$single_register_info->total_payable.'</td>';
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <select tabindex="2" class="form-control select2" id="user_id" name="user_id" style="width: 100%;">
                    <option value="" disabled selected hidden><?php echo ('Seleccionar Usuario'); ?></option>
                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="title" style="width: 10%"><?php echo lang('opening_balance'); ?></th>
                                <th class="title" style="width: 10%"><?php echo lang('sale'); ?> (<?php echo lang('paid_amount'); ?>)</th>
                                <th class="title" style="width: 5%"><?php echo ('Creditos'); ?> (<?php echo lang('paid_amount'); ?>)</th>
                                <th class="title" style="width: 5%"><?php echo ('Regalias'); ?> (<?php echo lang('paid_amount'); ?>)</th>
                                 <th class="title" style="width: 10%"><?php echo lang('customer_due_receive'); ?></th> 
                                ...
                                <!--<th class="title" style="width: 15%"><?php echo ('Total pagado'); ?></th> -->
                            </tr>
                        </thead>
                        <tbody>
                            <?php
