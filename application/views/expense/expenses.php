...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-2">
            <a href="<?php echo base_url() ?>Expense/addEditExpense"><button type="button" style="background: #ffd700; color: black;" class="btn btn-block  pull-right"><?php echo lang('add_expense'); ?></button></a>
        </div>
    </div>
</section>
