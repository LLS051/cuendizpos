...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-3">
            <a href="<?php echo base_url() ?>Customer_due_receive/addCustomerDueReceive"><button type="button" style="background: #ffd700; color: black;" class="btn btn-block pull-right"><?php echo lang('add_customer_due_receive'); ?></button></a>
        </div>
    </div>
</section>
