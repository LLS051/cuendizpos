...
<section class="content-header">
    <div class="row">
        <div class="col-md-6">
            <h2 class="top-left-header"><?php echo "Categorios de los Productos"; ?> </h2>
        </div>
        <div class="col-md-offset-3 col-md-3">
            <a href="<?php echo base_url() ?>Master/addEditFoodMenuCategory"><button type="button" class="btn btn-block btn-primary pull-right"><?php echo "Add Categories Products"; ?></button></a>
        </div>
    </div>
</section>
