...
<section class="content-header">
    <div class="row">
        <div class="col-md-6">
            <h2 class="top-left-header"><?php echo "Productos"; ?> </h2>
        </div>
        <div class="col-md-offset-2 col-md-4">
            <ul class="list-inline text-right">
                <li><a href="<?php echo base_url() ?>Master/addEditIngredient"><button type="button" class="btn btn-block btn-primary pull-right"><?php echo "Añadir Productos"; ?></button></a>
                </li>
