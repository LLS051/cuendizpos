            ...
            <div id="receiptData">
                ...
                <div id="receipt-data">
                    ...
                    <img src="<?php echo ss_location . ss_print_logo; ?>" alt="cuendizrestaurant" width="auto" height="80">
                        ...
                        <p><?php echo $this->session->userdata('address'); ?>
                            ...
                            <?php
                                ...
                                $method_sale = '';
                                if($sale_object->payment_method_id == 3){
                                    $method_sale = 'Efectivo';
                                }elseif($sale_object->payment_method_id == 4){
                                    $method_sale = 'Tarjeta';
                                }elseif($sale_object->payment_method_id == 5){
                                    $method_sale = 'Credito';
                                }elseif($sale_object->payment_method_id == 6){
                                    $method_sale = 'Regalia';
                                }
                            ?>
                    ...
                    <p>Fecha: <?= date($this->session->userdata('date_format'), strtotime($sale_object->sale_date)); ?> <?= date('H:i',strtotime($sale_object->order_time)) ?><br>
                        ...
                        Cliente: <?php echo "$sale_object->customer_name"; ?><br>
                    ...
                    <table class="table table-condensed">
                        ...
                        <p> Tipo de pago:  <?= $method_sale?> <br>
                             Pago Con: <?php echo $this->session->userdata('currency') . " " . number_format($sale_object->given_amount, 2); ?> <!-- paid_amount--> <br>
                             Cantidad de Vuelto: <?php echo $this->session->userdata('currency') . " " . number_format($sale_object->change_amount, -2); ?> <!-- due_amount-->
                         </p>
                    </table> <br>
