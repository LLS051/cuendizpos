 ...
 */
$i = 1;
$cateogry_slide_to_show = '<button class="category_button" id="button_category_show_all" style="border-left: solid 2px #DEDEDE;">Todo</button>';
...
foreach ($tables as $table) {
    ...
    $tables_modal .= '<button class="floatleft bottom_add" id="single_table_order_details_bottom_add_' . $table->id . '">Añadir</button>';
    $tables_modal .= '</div>';
    $tables_modal .= '</div>';
    $tables_modal .= '</div>';
...
foreach ($new_orders as $single_new_order) {
    ...
    // $order_list_left .= '<p class="order_on_processing">'.('Comienzo en Cocina').': '.$total_kitchen_type_started_cooking_items.'/'.$total_kitchen_type_items.'</p>';
    // $order_list_left .= '<p class="order_done">'.('Listo').': '.$total_kitchen_type_done_items.'/'.$total_kitchen_type_items.'</p>';
    // $order_list_left .= '</div>';
    // $order_list_left .= '<div class="order_condition">';
    // $order_list_left .= '<p style="font-size:16px;">'.('Conte de Tiempo').': <span id="order_minute_count_'.$single_new_order->sales_id.'">'.str_pad(round($minutes), 2, "0", STR_PAD_LEFT).'</span>:<span id="order_second_count_'.$single_new_order->sales_id.'">'.str_pad(round($seconds), 2, "0", STR_PAD_LEFT).'</span> M</p>';
    // $order_list_left .= '</div>';
    $order_list_left .= '</div>';
    $order_list_left .= '</div>';
    $i++;
...
<head>
    ...
    <script type="text/javascript">
        ...
        var added_running_order = "<?php echo 'La orden se a generado, aparecera en facturas, para proceder a crearla y cerrar'; ?>";
    </script>
...
<body>
    ...
    <div class="wrapper fix">
        ...
        <div class="cont-part" id="main_part fix">
            <div class="  left fix">
                <div class="sub-cont-left holder fix">
                    <div>
                    ...
                    <div style="width:100%;" id="left_side_button_holder_absolute">
            ...
            <div style="display: flex;flex-direction: column;justify-content: space-between;" class=" middle fix">
                <div>
                    <div class="main_top fix">
                        <div class="button_holder fix">
                            ...
                            <div class="single_button_middle_holder fix">
                                <button data-selected="unselected" style="float:right;margin-right:2px;" id="delivery_button" class="newdelivery"><i class="fas fa-truck"></i> <?php echo lang('delivery'); ?></button>
                            </div>
                        </div>
                        <div class="waiter_customer">
                            <div class="single_button_middle_holder" style="padding-left:.4%;width:25%">
                                <select style="width:92%;margin-left:2px;" id="select_waiter" class="select2">
                                    <option value="" disabled selected hidden><?php echo ('Trabajador'); ?></option>
                            ...
                            <div class="single_button_middle_holder">
                                <div style="width:92%;margin:0 auto;">
                                    <select id="walk_in_customer" id="select_walk_in_customer" class="select2">
                                        <option value="" disabled selected hidden><?php echo lang('customer'); ?></option>
                        ...
                        <span style="color: white; font-weight: bold;">Agregar cliente</span>
                    </div>
                    ...
                    <div style="width: 100% ; background: #F5F5F5; " id="bottom_absolute">
                        <table cellspacing="0" cellpadding="0">
                            <tr style="background-color: #ffffff" class="scroll1">
                ...
                <div class="main_bottom fix" style="padding-top:2px;">
                    <div class="button_group fix">
                        <div class="single_button_middle_holder cart_bottom_buttons" style="width:17%;">
                            <button style="float:left;padding:0px 3px;" id="cancel_button" class="newcancel"><i class="fas fa-times"></i> <?php echo lang('cancel'); ?></button>
                        </div>
                        <div style="text-align:center;width:20%;" class="single_button_middle_holder cart_bottom_buttons">
                            <button id="hold_sale" style="padding:0px 3px;" class="newfre"><i class="fas fa-hand-rock"></i></i> <?php echo lang('hold'); ?></button>
                        </div>
                        ...
                        <div class="single_button_middle_holder cart_bottom_buttons" style="width:50%;">
                            <button style="float:right;margin-right:2px;padding:0px 3px;" id="place_order_operation" class="newcreate"><i class="fa fa-check-square-o"></i> <span id="place_edit_order"><?php echo 'Realizar Venta'; ?></span></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class=" main_right fix">
                <input type="text" name="search" id="search" placeholder="<?php echo 'Busqueda'; ?>" />
    ...
    <div id="item_modal" class="modal">
        ...
        <div class="modal-content">
            ...
            <div id="modal_discount_section">
                <p style="float: left;margin: 0px 0px 0px 2px;font-size: 19px;">Discount</p><input type="text" name="" id="modal_discount" placeholder="Amt or %" />
            </div>
                    ...
                    <div class="hold_sale_right fix">
                        <div class="top fix">
                            <div class="top_middle fix">
                                ...
                                <div class="waiter_customer_table fix">
                                    <div class="waiter fix"><span style="font-weight: bold;"><?php echo 'Trabajador'; ?>: </span><span style="display:none;" id="hold_waiter_id"></span><span id="hold_waiter_name"></span></div>
            ...
            <div class="last_ten_sales_modal_info_holder fix">
                <div class="last_ten_sales_holder fix">
                    <div class="hold_sale_left fix">
                        ...
                        <div style="margin-top: 28px;" class="hold_list_holder fix">
                            <div class="header_row fix">
                            ...
                            <div class="top_middle fix">
                                ...
                                <div class="waiter_customer_table fix">
                                    <div class="fix order_type">
                                        ...
                                        <div class="waiter fix"><span style="font-weight: bold;"><?php echo 'Trabajador'; ?>: </span><span style="display:none;" id="last_10_waiter_id"></span><span id="last_10_waiter_name"></span></div>
                    ...
                    <div class="top_middle fix">
                        ...
                        <div class="waiter_customer_table fix">
                            <div class="fix order_type">
                                ...
                                <span style="font-weight: bold;"><?php echo 'Factura'; ?>: </span>
                                <span id="order_details_order_number" style="display: inline-block;"></span>
                                <div class="waiter fix"><span style="font-weight: bold;"><?php echo 'Trabajador'; ?>: </span><span style="display:none;" id="order_details_waiter_id"></span><span id="order_details_waiter_name"></span></div>
                        ...
                        <div class="item_modifier_details fix">
                            <div class="modifier_item_header fix">
                                <div class="first_column_header column_hold fix"><?php echo lang('item'); ?></div>
                                <div class="second_column_header column_hold fix"><?php echo lang('price'); ?></div>
                                <div class="third_column_header column_hold fix"><?php echo 'Qty'; ?></div>
                                <div class="forth_column_header column_hold fix"><?php echo lang('discount'); ?></div>
                                <div class="fifth_column_header column_hold fix"><?php echo lang('total'); ?></div>
                            </div>
                            <div class="modifier_item_details_holder fix">
    ...
    <div id="finalize_order_modal" class="modal">
        ...
        <div class="modal-content" id="modal_finalize_order_details">
            ...
            <!-- cont body modal finalizar orden -->
            <div style="padding: 0px 20px;">
                <div style="margin: 15px 0px 0px 0px; border-bottom: 3px solid #B5D6F6;" class="fo_2 fix">
                    <div class="half fix floatleft">Tipo de Cambio</div>
                ...
                <!--  <div class="tabs">
                    <div class="tab">
                        ...
                        <label class="tab-label" for="chck1">Otras opciones de pago </label>
                        <div class="tab-content">
                            ...
                            <div class="fo_2 fix">
                                <div class="half fix floatleft">Pago total</div>
                                <div class="half fix floatleft textright">
                                    <select name="finalie_order_payment_method" id="finalie_order_payment_method">
                            ...
                            <div class="fo_3 fix">
                                <div class="half fix floatleft textleft">Pagar la cantidad</div>
                                <div class="half fix floatleft textright">Cantidad Debida</div>
                                <div class="half fix floatleft textleft"><input type="text" name="pay_amount_invoice_modal_input" id="pay_amount_invoice_input"></div>
                                <div class="half fix floatleft textright"><input type="text" name="due_amount_invoice_modal_input" id="due_amount_invoice_input" disabled></div>
                            </div>
                            <div class="fo_3 fix">
                                <div class="half fix floatleft textleft">Cantidad dada</div>
                                <div class="half fix floatleft textright">Cambiar cantidad</div>
                                <div class="half fix floatleft textleft"><input type="text" name="given_amount_modal_input" id="given_amount_input"></div>
                                <div class="half fix floatleft textright"><input type="text" name="change_amount_modal_input" id="change_amount_input" disabled></div>
                            </div>
                        </div>
 ...
 -->
                <div class="bottom_buttons fix">
                    <div class="bottom_single_button floatleft textleft half fix"><button style="background: #FF0000; color: white ;" id="finalize_order_cancel_button"><?php echo lang('cancel'); ?></button></div>
                    <div class="bottom_single_button floatleft textright half fix"><button style="background: #3E0085; color: white;" c id="finalize_order_button"><?php echo lang('submit'); ?></button></div>
                </div>
            </div>
            <!-- <span class="close">&times;</span> -->
            <!-- <p>Some text in the Modal..</p> -->
    ...
    <div id="calculator_main">
     ...
     <!-- The Modal edit Pricing -->
     <div id="customer_item_modal" class="modal" style="padding-top:20px;">

<!-- Modal content -->
<div class="modal-content">
    <h1><?php echo 'Producto'; ?></h1>

    <div style="padding: 0px 10px;" class="customer_add_modal_info_holder">
        <input type="hidden" id="products_id" value="">
        <div style="display: flex ; justify-content: space-between;border-bottom: 2px #B5D6F6 solid; align-items: center;" class="customer_section fix ">
            <p class="input_level"><?php echo 'Nombre del Producto'; ?> <span style="color:red;">*</span></p>
            <input style="height: 28px;border: 1px solid #434343;" type="text" class="add_customer_modal_input" id="products_name" required>
        </div>
        <div style="margin-bottom: 10px; display: flex ; justify-content: space-between;border-bottom: 2px #B5D6F6 solid; align-items: center;" class="customer_section fix">
            <p class="input_level"><?php echo 'Precio Actual'; ?> <span style="color:red;">*</span></p>
            <input style="height: 28px;border: 1px solid #434343;" type="text" class="add_customer_modal_input" id="products_pricing" required>

    </div>

    <div style="display: flex;justify-content: space-between;margin: 20px 0px;" class="section7 fix">
        <div class="sec7_inside" id="sec7_1"><button style="background: red; color: white;" id="close_customer_item_modal"><?php echo lang('cancel'); ?></button></div>
        <div class="sec7_inside" id="sec7_2"><button style="background: #FFD700; color: black;" id="edit_pricing_products"><?php echo 'Actualizar Producto'; ?></button></div>
    </div>
    <!-- <span class="close">&times;</span> -->
    <!-- <p>Some text in the Modal..</p> -->
</div>
...
<!-- End Modal -->
    ...
    <div id="direct_invoice_button_tool_tip" style="display:none;position: absolute;background: #fff;border: 1px solid #cfcfcf;border-radius: 5px;box-shadow: 2px 2px 2px #cfcfcf;padding:5px;">
        <h1 class="title" style="display:none;margin:0px;font-size: 20px;line-height: 25px;">For Fast Food Restaurants</h1>
    </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        swal({
                            ...
                            confirmButtonColor: '#89ff89'
                        });
                        $('#close_register_button').hide();
                        window.location.href = '<?php echo base_url() ?>Dashboard/dashboard'; /* Authentication/logOut*/
                    },
                    error: function() {
                        alert("error");
                    }
