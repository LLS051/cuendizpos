        ...
        <div class="modal-content">
            ...
            <div class="customer_add_modal_info_holder">
                ...
                <div class="customer_section fix">
                    ...
                    <input type="text" class="add_customer_modal_input" id="products_name" required>
                </div>
                <div class="customer_section fix">
                    <p class="input_level"><?php echo 'Precio Actual'; ?> <span style="color:red;">*</span></p>
                    <input type="text" class="add_customer_modal_input" id="products_pricing" required>

            </div>

            <div class="section7 fix">
                <div class="sec7_inside" id="sec7_1"><button id="close_customer_item_modal"><?php echo lang('cancel'); ?></button></div>
                <div class="sec7_inside" id="sec7_2"><button id="edit_pricing_products"><?php echo 'Actualizar Producto'; ?></button></div>
            </div>
            <!-- <span class="close">&times;</span> -->
            <!-- <p>Some text in the Modal..</p> -->
        </div>
