...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <style type="text/css">
            .secondbg{
                ...
                top:0;
                width:100%;
                background-image: url('<?php echo ss_location . ss_background; ?>') !important;
    ...
    <body class="hold-transition login-page secondbg" style="">
        <div class="login-box">
            <?php
            ...
            <div class="login-box-body">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" name="email_address" placeholder="<?php echo lang('email_address'); ?>" > <!-- value="admin@gmail.com" value="admin" -->
                ...
                <div class="row">
                    <!-- /.col -->
                    <div class="col-xs-12">
                        <button type="submit" name="submit" value="submit" class="newbtn btn btn-primary btn-block btn-flat"><?php echo lang('login'); ?></button>
                    </div>
                    <!-- /.col -->
                </div>
                <?php echo form_close(); ?>
