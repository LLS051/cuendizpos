                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td><input tabindex="3" class="form-control integerchk" readonly type="text" name="paid" id="paid" onfocus="this.select();" onkeyup="return calculateAll()" <?php echo set_value('paid'); ?>></td>
                                        <td style="width: 5%;text-align: right"> <span class="label_aligning_total_loss">
                                                <?php echo $this->session->userdata('currency'); ?>
