...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-2">
            <a href="<?php echo base_url() ?>Purchase/addEditPurchase"><button style="background:#ffd700 ; color: black;" type="button" class="btn btn-block pull-right"><?php echo lang('add_purchase'); ?></button></a>
        </div>
    </div>
</section>
