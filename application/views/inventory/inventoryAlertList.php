...
<section class="content-header">
    <div class="col-md-12 text-center">
        <h2 class="top-left-header">Alerta de Inventario </h2>
    </div>
    <div class="row">
        <div class="col-md-1">
            <a href="<?= base_url() . 'Inventory/index' ?>" class="btn btn-block btn-primary pull-left"><strong>Atras</strong></a>
        </div>
                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="title" style="width: 37%">Ingredientes(Code)</th>
                                <th class="title" style="width: 20%">Categoria</th>
                                <th class="title" style="width: 20%">Stock Conteo</th>
                                <th class="title" style="width: 20%">Alerta Conteo</th>
                            </tr>
                        </thead>
                        ...
                        <tfoot>
                            <tr>
                                <th class="title" style="width: 5%">SN</th>
                                <th class="title" style="width: 37%">Ingrediente(Code)</th>
                                <th class="title" style="width: 20%">Categoria</th>
                                <th class="title" style="width: 20%">Stock Cant/Conteo</th>
                                <th class="title" style="width: 20%">Alert Cant/Conteo</th>
                            </tr>
                        </tfoot>
                    </table>
