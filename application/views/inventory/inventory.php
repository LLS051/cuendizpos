...
<section class="content-header">
    ...
    <div class="row">
        ...
        <div class="col-md-1">
            <button type="submit" name="submit" value="submit" style="background: #ffd700; color: black;"  class="btn btn-block pull-left"><?php echo lang('submit'); ?></button>
        </div>
        <div class="hidden-lg"><span style="color:transparent">space</span></div>
        <div class="col-md-2">
            <a href="<?= base_url() . 'Inventory/getInventoryAlertList' ?>" style="background: #ffd700; color: black;" class="btn btn-block  pull-left"><span style="color:red"><?= getAlertCount() ?></span> <?php echo lang('ingredients_alert'); ?> </a>
        </div>
                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="title" style="width: 37%"><?php echo "Descripcion"; ?>(<?php echo lang('code'); ?>)</th>
