    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <img src="<?php echo ss_location . ss_home_mini_logo; ?>" style="height: 55px; width: auto;">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu left-sdide">
                    <ul style="height: 51px;display: flex;align-items: center;" class="nav navbar-nav">

                        <?php if ($this->session->userdata('outlet_id')) { ?>
                            <!-- User Account: style can be found in dropdown.less -->
                            <?php if (in_array('Sale', $this->session->userdata('menu_access'))) { ?>
                                <li class="dropdown user user-menu">
                                    <a style="padding: 5px 5px;" href="<?php echo base_url(); ?>Sale/POS">
                                        <i class="fa fa-usd"></i>
                            ...
                            <?php if (in_array('Purchase', $this->session->userdata('menu_access'))) { ?>
                                <li class="dropdown user user-menu">
                                    <a style="padding: 5px 5px;" href="<?php echo base_url(); ?>Purchase/addEditPurchase">
                            ...
                            <?php if ($this->session->userdata('role') == "Admin") { ?>
                                <li class="dropdown user user-menu">
                                    <a style="padding: 5px 5px;" href="#" onclick="todaysSummary();" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            ?>
                                <li class="dropdown user user-menu">
                                    <a style="padding: 5px 5px;" href="#" onclick="shortcut();" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <li class="dropdown user user-menu">
                                <a style="padding: 5px 5px;" href="#" id="register_details">
                            ...
                            <li class="dropdown user user-menu" id="close_register_button" style="display:none">
                                <a style="padding: 5px 5px;" href="#" id="register_close">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <li class="dropdown messages-menu open menudown" style="width: 150px;padding-top: 12px;">
                            ...
                            <select tabindex="2" class="form-control select2 menudown" name="language" style="width: 100%;" onchange='this.form.submit()'>
                        ...
                        <!-- User Account: style can be found in dropdown.less -->
                        <li class="dropdown user user-menu">
                            <a href="<?php echo base_url(); ?>Authentication/logOut" class="logout1">Cerrar Sesion
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?php echo base_url(); ?>assets/images/login-back.webp" class="img-circle" alt="User Image">
                    </div>
                    <div class="pull-left info" style="position: sticky !important;">
                ...
                <div id="left_menu_to_scroll">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <?php if (in_array('Sale', $this->session->userdata('menu_access'))) { ?>
                            <li>
                                <a href="<?php echo base_url(); ?>Sale/sales"><i class="fa fa-usd"></i> <span><?php echo lang('sale'); ?></span></a>
                            </li>
                        <?php } ?>
        ...
        $('#register_details').on('click', function() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var sale_in_stripe = (response.sale_in_stripe == null) ? 0 : response.sale_in_stripe;
                    ...
                    var total_payable = (response.total_payable == null) ? 0 : response.total_payable;
                    ...
                    register_detail_modal_content += '<p><?php echo lang('sale'); ?> <?php echo lang('in'); ?> <?php echo ('Efectivo'); ?>: ' + currency + ' ' + sale_in_cash + '</p>';
                    register_detail_modal_content += '<p><?php echo lang('sale'); ?> <?php echo lang('in'); ?> <?php echo ('Credito'); ?>: ' + currency + ' ' + sale_in_paypal + '</p>';
                    register_detail_modal_content += '<p><?php echo lang('sale'); ?> <?php echo lang('in'); ?> <?php echo ('Tarjeta'); ?>: ' + currency + ' ' + sale_in_card + '</p>';
                    register_detail_modal_content += '<p><?php echo lang('sale'); ?> <?php echo lang('in'); ?> <?php echo ('Regalia'); ?>: ' + currency + ' ' + sale_in_stripe + '</p>';
